      ...
      <div className='grid min-h-screen lg:grid-cols-2'>
        ...
        >
          <nav>
            <motion.a
              href='/'
              className='flex items-center gap-3 font-medium text-slate-900 dark:text-white'
              whileHover={{ scale: 1.05 }}
              transition={{ type: 'spring', stiffness: 400, damping: 10 }}
            >
              <div className='flex h-8 w-8 items-center justify-center rounded-md bg-muted shadow-md gap-4'>
                <img
                src='/favBlur.svg'
                alt='Logo'
          ...
          <div className='flex flex-1 items-center justify-center py-12'>
            <motion.div
              className='w-full max-w-md rounded-2xl bg-white/80 p-8 backdrop-blur-sm shadow-xl dark:bg-slate-800/80'
